...
- 保存桌面首屏 `output/playwright/repopilot-browser-smoke-desktop.png`、全页证据 `output/playwright/repopilot-browser-smoke.png` 和 390×844 移动端首屏 `output/playwright/repopilot-browser-smoke-mobile.png`。
